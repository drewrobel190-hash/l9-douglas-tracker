const rareOptions = [
    { name: "Critical Hit Damage", value: "7%", success: "10%" },
    { name: "All Damage in PvP", value: "10%", success: "10%" },
    { name: "Attack Speed", value: "7%", success: "10%" },
    { name: "Accuracy", value: "60", success: "10%" },
    { name: "Endurance Ignore in PvP", value: "55", success: "10%" },
    { name: "HP Recovery in Battle", value: "30", success: "10%" },
    { name: "MP Recovery in Battle", value: "15", success: "10%" },
    { name: "Gold Gain", value: "1.5%", success: "10%" },
    { name: "Barrier Increase Rate", value: "3.5%", success: "10%" },
    { name: "Skill MP Consumption Decrease", value: "1.5%", success: "10%" }
];

const rareArmorOptions = [
    { name: "Damage Received Decrease", value: "2%", success: "10%" },
    { name: "Defense Power", value: "15", success: "10%" },
    { name: "Endurance in PvP", value: "11", success: "10%" },
    { name: "Ranged Critical Hit Resistance", value: "18", success: "10%" },
    { name: "Magic Critical Hit Resistance", value: "18", success: "10%" },
    { name: "Max HP", value: "300", success: "10%" },
    { name: "Max MP", value: "140", success: "10%" },
    { name: "Gold Gain", value: "0.7%", success: "10%" },
    { name: "Bag Weight", value: "70", success: "10%" },
    { name: "Potion Recovery Rate", value: "1.4%", success: "10%" }
];
